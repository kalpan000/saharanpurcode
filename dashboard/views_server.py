import json
import itertools
from dashboard.models import SNMPDataCollection , SNMPInterfaceDataCollection, AddDevice
...
def frontendFunc(request , firstRun = 1 , duration = "Live" , ip = "" , type = ""):
    ...
    if ip != "": 
        ...
        return JsonResponse({"error" : False , "mode" : mode , "data" : {
            "data" : cpu,
